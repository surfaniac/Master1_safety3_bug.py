...
def zeichnen(anzahl_verbindungen, auslasser, w_faktor, l_faktor, r_faktor, ra_faktor):
...
model = zeichnen(anzahl_verbindungen, auslasser, w_faktor, l_faktor, r_faktor, ra_faktor)

grid = GridSearchCV(estimator=model, param_grid=dict(anzahl_verbindungen = anzahl_verbindungen, auslasser = auslasser, w_faktor = w_faktors, l_faktor = l_faktors, r_faktor = r_faktors, ra_faktor = ra_faktors), scoring = bild_score(im, im_end), verbose = 1)
#grid.fit(dataset.data, dataset.target)
print(grid)
# summarize the results of the grid search
print(grid.best_score_)
print(grid.best_estimator_.w_faktor)
print(grid.best_estimator_.l_faktor)
print(grid.best_estimator_.r_faktor)
print(grid.best_estimator_.ra_faktor)
