...
def zeichnen(source, anzahl_verbindungen, auslasser):
...
x = alle_verbindungen_score(naegel, w_faktor = 1.5, l_faktor = -1, r_faktor = 8, ra_faktor = 6)
score_liste = sortieren(x)
print(len(score_liste))
print(score_liste[:10])
zeichnen(score_liste, 12000, 3)
print(bild_score(im, im_end))
